...
Copyright (c) 2024 by anonymous (http://jsbin.com/yifeyurena/1/edit)
...
<html>
<head>
    <title>Form Peak - Lead Capture Page</title>
    ...
    <style>
        ...
        .hero {
            width: 100%;
            height: 100vh;
            background: url(https://source.unsplash.com/1600x900/?fitness) center center no-repeat;
...
<body x-data="{ open: false }">
    <header class="nav">
        <nav class="container mx-auto flex items-center justify-between py-4">
            <a href="#" class="text-white text-lg"><b><u>From Peak</u></b></a>
    ...
    <section class="hero">
        <div class="container mx-auto">
            <h1 class="text-4xl mb-4"><b>Move Harder and Thrive</b></h1>
            ...
            <div class="cta mt-8">
                <a href="#" class="hover:bg-gray-800 bg-black text-white py-3 px-6 rounded-lg">Let's Move</a>
            </div>
        </div>
    </section>
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
          <div class="bg-white rounded shadow-lg p-6">
            <div class="flex mb-4">
              ...
              <div>
                <h2 class="text-lg font-semibold">John</h2>
                <p class="text-gray-700">Physiotherapist</p>
              </div>
            </div>
            <p class="text-gray-700">As
    </section>
        ...
        <div class="flex justify-center mt-12">
            ...
            <div class="w-1/3 px-4">
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    ...
                    <p class="mt-6 text-2xl font-bold">$9.99/month</p>
